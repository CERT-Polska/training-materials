...
if len(argv) < 4:
    logging.debug("Usage: python LoadDataToMISP.py <MISP hostname> <Events JSON file> <new password>")
    exit()
...
try:
    ...
    params = {
        ...
        'data[User][password]': currentPassword,
    ...
    params = {
        ...
        'data[User][current_password]' : currentPassword,
        'data[_Token][fields]': '%s' % fields,
        'data[_Token][unlocked]': ''
    }
